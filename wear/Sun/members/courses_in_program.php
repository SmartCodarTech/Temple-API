...
<?php $user = get_user($session->user_id);?>
    ...
    <h1 class="text-capi lato-light text-center super3">Courses Offered For <?php echo htmlentities(get_program_name_by_id($id));?></h1>
    <p class="text-center lato-regular text-size-18"> For This Program <?php echo htmlentities(get_program_name_by_id($id));?></p>
