...
<form action="<?php echo htmlentities(BASE_URL);?>blog/saveVideo/<?php echo htmlentities($video->id);?>" method="POST" class="form-horizontal"> 
...
<div class="col-sm-5"> 
<input name="title" value="<?php echo htmlentities($video->title);?>" type="text" class="bg-focus form-control" data-required="true"> 
...
<div class="col-sm-5"> 
<input name="author" value="<?php echo htmlentities($video->author);?>" type="text"  class="bg-focus form-control" data-required="true"> 
            </div>
</div> 
...
<div class="col-sm-5"> 
<input size="16"  data-date-format="yyyy-mm-dd" name="release_date" value="<?php echo htmlentities($video->release_date);?>" type="text"  class="datepicker bg-focus form-control" data-required="true"> 
            </div>
</div>
<div class="form-group"> 
...
<li ><a href="#">
<input type="radio" name="disable_frown" <?php if($video->disable_frown == 1){ ?>checked="Checked" <?php }?> value="1">No</a></li> 
<li><a href="#">
<input type="radio" name="disable_frown" <?php if($video->disable_frown == 2){ ?>checked="Checked" <?php }?>value="2">YES</a></li> 
</ul> 
</div>
</div> 
</div>
...
<div class="col-sm-5"> 
<textarea  name="summary" value=""   class=" bg-focus form-control" data-required="true"><?php echo htmlentities($video->summary);?> </textarea> 
            </div>
</div>
<div class="form-group"> 
...
<textarea id="editor" name="article" placeholder="The Devotion "   class=" bg-focus form-control" data-required="true">
	<?php echo htmlentities($video->article);?>
</textarea> 
            </div>
</div>
