...
<form action="<?php echo htmlentities(BASE_URL);?>blog/saveSection/<?php echo htmlentities($section->id);?>" method="POST" class="form-horizontal"> 
...
<div class="col-sm-5"> 
<input name="name" value="<?php echo htmlentities($section->name);?>" type="text" class="bg-focus form-control" data-required="true"> 
...
<div class="col-sm-5"> 
<textarea id="" name="description" placeholder="The Description "   class=" bg-focus form-control" data-required="true"><?php echo htmlentities($section->description);?></textarea> 
            </div>
</div>
...
<li ><a href="#">
<input type="radio" name="members_only" <?php if($section->members_only == 1){?> checked="Checked" <?php }?> value="1">NO</a></li> 
<li><a href="#">
<input type="radio" name="members_only"<?php if($section->members_only == 2){?> checked="Checked" <?php }?> value="2">YES</a></li> 
</ul> 
</div>
</div> 
</div>
...
<div class="col-sm-4 col-sm-offset-3"><button class="btn btn-primary" name="submit" type="submit">Edit Section</button> 
</div> 
</div> 
</form>
