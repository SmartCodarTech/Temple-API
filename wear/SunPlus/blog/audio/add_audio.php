...
<form action="<?php echo htmlentities(BASE_URL);?>blog/addAudio" method="POST" class="form-horizontal"> 
...
<li ><a href="#">
<input type="radio" class="text-capi text-left text-size-24 lato-light gray" name="disable_frown" checked="Checked" value="1">NO</a></li> 
<li><a href="#">
<input type="radio" class="text-capi text-left text-size-24 lato-light gray" name="disable_frown" value="2">YES</a></li> 
</ul> 
</div>
</div> 
</div>
