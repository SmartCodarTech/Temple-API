...
<form action="<?php echo htmlentities(BASE_URL);?>blog/addArticle" method="POST" class="form-horizontal"> 
...
<div class="form-group"> 
<label class="col-sm-3 control-label">Disable Frown Feature
</label> 
<div class="col-sm-6"> 
...
<div class="col-sm-4 col-sm-offset-3"> <button class="btn btn-primary" name="submit" type="submit">Add Article</button> 
</div> 
</div> 
</form>
