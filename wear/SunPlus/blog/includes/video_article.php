 ...
 <?php $videoats = get_video_articles(); ?> 
<!-- Modal -->
  <div class="modal fade" id="addToArticle-<?php echo htmlentities($video->id);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <?php  if(!empty($videoats)){?>
      <form action="<?php echo htmlentities(BASE_URL);?>blog/addvideoItem/<?php echo htmlentities($video->id);?>/internal" method="POST" enctype="multipart/form-data" class="form-horizontal"> 
...
<?php foreach($videoats as $videoat){?>
<li ><a href="#">
<input type="radio" name="article" checked="" value="<?php echo htmlentities($videoat->id)?>"><?php echo htmlentities($videoat->title)?></a></li> 
<?php } ?>
